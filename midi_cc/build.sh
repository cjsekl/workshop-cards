...
# Workshop System MIDI CC Build Script
# Builds the MIDI CC card for Music Thing Modular Workshop System

set -e  # Exit on any error

echo "========================================="
echo "Workshop System MIDI CC Build Script"
echo "========================================="
...
# Build the project
echo "Building MIDI CC card..."
make -j$(nproc)

# Check if .uf2 file was created
if [ -f "midi_cc.uf2" ]; then
    echo ""
    echo "========================================="
    echo "BUILD SUCCESSFUL!"
    echo "========================================="
    echo "Generated files:"
    echo "  midi_cc.uf2    - Flash file for Workshop System"
    echo "  midi_cc.elf    - Debug executable"
    echo "  midi_cc.bin    - Binary file"
    echo "  midi_cc.hex    - Hex file"
    echo ""
    echo "To flash to Workshop System:"
    echo "1. Hold down BOOTSEL button on the computer module"
    echo "2. Connect USB cable"
    echo "3. Release BOOTSEL button"
    echo "4. Copy midi_cc.uf2 to the RPI-RP2 drive"
    echo ""
    echo "File location: $(pwd)/midi_cc.uf2"
    echo "========================================="
else
    echo ""
    echo "========================================="
