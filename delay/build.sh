...
if [ -f "delay.uf2" ]; then
    ...
    echo "  delay.uf2    - Flash file for Workshop System"
    echo "  delay.elf    - Debug executable"
    echo "  delay.bin    - Binary file"
    echo "  delay.hex    - Hex file"
    echo ""
    echo "To flash to Workshop System:"
    echo "1. Hold down BOOTSEL button on the computer module"
    echo "2. Connect USB cable"
    echo "3. Release BOOTSEL button"
    echo "4. Copy delay.uf2 to the RPI-RP2 drive"
    echo ""
    echo "File location: $(pwd)/delay.uf2"
    echo "========================================="
else
    echo ""
    echo "========================================="
